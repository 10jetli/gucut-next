              ...
              <div className="mt-2 border border-red-200 bg-red-50 rounded-md px-3 py-2.5">
                ...
                {เรียง.length > 0 && (
                  <>
                    ...
                    {/* 🔴 **แก้ถ้อยคำ 18 ก.ย. 2569 ตามกฎที่ CEO ตั้งวันเดียวกัน**
                        "ข้อความสรุปพูดได้แค่เรื่องที่มันวัด · จะอ้างสาเหตุต้องวัดสาเหตุนั้นด้วย"
                        ฉบับแรกเขียนว่า "รหัสแปรของมาร์เก็ตเพลส" — **เราไม่ได้วัดว่ามันมาจากไหน**
                        สิ่งที่วัดจริงมีสองอย่าง: รหัสนั้นไม่มีแถวของตัวเองในคลังเรา · รหัสฐานของมันติดลบ
                        ⇒ เขียนเท่าที่วัด · ความหมายที่ใช้ลงมือไม่หายไปเลย */}
                    <p className="text-[11.5px] text-red-800 mt-0.5 leading-relaxed">
                      รหัสพวกนี้<b>ไม่มีแถวสต็อกของตัวเองในคลังเรา</b> ตัวที่ติดลบคือ<b>รหัสฐาน</b>ของมัน
                      {' '}⇒ แก้ที่รหัสฐานทีเดียวปลดได้ทั้งพวง · <b>จอคลังไม่มีแถวพวกนี้ให้เห็น</b>
                    </p>
                  </>
                )}
                {เรียง.length === 0 && (
