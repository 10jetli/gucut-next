 ...
 *    ⚠️ **ข้อเท็จจริงใหม่ 17 ก.ย. 2569 (ใบ t_mu2u9mym) — เหตุผลข้อ "ZORT เองก็ไม่มี" ไม่ตรงกับของจริง**
 *       ZORT มีจอรวม `/FileUpload/list` "จัดการไฟล์" แสดงสลิปทั้งร้าน 381 ไฟล์ พร้อมแท็บตามประเภท ·
 *       คอลัมน์ ไฟล์ · ประเภท · รายการ · โดย · วันที่อัพโหลด (อ่านอย่างเดียว ไม่ได้กด Export)
 *       ⇒ **เหตุผลเรื่องความเสี่ยงยังอยู่ครบ** · ส่งให้ CEO ตัดสินว่าจะคงการตัดสินใจเดิมไหม — **ไม่ได้ทำจอรวมเอง**
 *
