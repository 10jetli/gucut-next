...
export default function NegVsPush() {
  ...
  return (
    <div className="text-[12px] text-amber-900 bg-amber-50 border border-amber-200 rounded-md px-3.5 py-2.5 mb-3 leading-relaxed">
      ...
      {/* เขียนเท่าที่วัดได้ — เราวัดว่า "ไม่มีแถวของตัวเองในคลัง" กับ "รหัสฐานติดลบ"
          ไม่ได้วัดว่ารหัสพวกนี้มาจากไหน ⇒ ห้ามเขียนว่าเป็นรหัสของมาร์เก็ตเพลส */}
      {' '}และใน <b>{ผล.ไม่โผล่}</b> รหัสนั้น<b>ไม่มีแถวในจอนี้เลย</b>
      {' '}(ไม่มีสต็อกของตัวเองในคลังเรา — ตัวที่ติดลบคือรหัสฐานของมัน)
      <br />
