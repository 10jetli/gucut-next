'use client'
// จอทะเบียนการเงินของ ZORT ที่หน้าตาเหมือนกัน 3 จอ — **ลอกจากภาพจริง**
...
//
// ทั้งสามจอที่ ZORT **ว่างเปล่าจริง ๆ (0 รายการ)** เพราะร้านลงบัญชีพวกนี้ที่ PEEK/PEAK
...
export default function LedgerScreen({
  title, cols, createLabel, soonKey, withImport, withTabs, sumLabel, purpose, meanwhile,
}: {
  title: string
  cols: LedgerCol[]
  createLabel: string
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      {withTabs && (
        <div className="flex items-center gap-6 border-b border-gray-200 mb-0 px-1">
          {['ทั้งหมด', 'รอชำระ', 'สำเร็จ'].map((t, i) => (
            <span key={t}
      ...
      <p className="text-[12px] text-gray-500 mt-2 leading-relaxed">
        ผังจอลอกจาก ZORT ของจริง · ปุ่ม <b>{createLabel}</b>
        {withImport && <> และ <b>นำเข้าไฟล์ (Excel)</b></>} ยังทำงานไม่ได้ กดแล้วจะบอกว่าติดอะไรอยู่ ·
