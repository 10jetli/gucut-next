    ...
    <div className="p-4 md:p-6">
      ...
      {d && !d.skip && (
        <>
          ...
          {/* 🔴 **ตัวเลขคงเหลือในจอนี้คือของ "สองสาขารวมกัน" ไม่ใช่สาขาเดียว** (ฝั่งท่อชี้ 6 ก.ย.)
              ต้องเขียนให้เห็นชัด ไม่ใช่ซ่อนในบรรทัดสีเทา — คนอ่านเลข "เหลือ 12"
              แล้วเดินไปหยิบที่สาขาตัวเอง จะไม่เจอของ เพราะ 12 นั้นอาจอยู่อีกสาขาทั้งก้อน
          ...
          <div className="text-[12.5px] text-amber-900 bg-amber-50 border border-amber-300 rounded-md px-3.5 py-2.5 mb-3 leading-relaxed">
            ⚠️ <b>ตัวเลขคงเหลือทุกตัวในจอนี้คือของสองสาขารวมกัน</b> ไม่ใช่ของสาขาใดสาขาหนึ่ง —
            ของที่ &ldquo;เหลืออยู่&rdquo; อาจอยู่อีกสาขาทั้งก้อน · แยกดูรายสาขายังทำไม่ได้
            (ZORT ไม่เปิดเส้นดึงสต็อกแยกรายคลัง)
          </div>
