        ...
        <>
          ...
          {/* 🔴 **ตัวเลขคงเหลือในจอนี้คือของ "ทุกคลังรวมกัน"** (ฝั่งท่อชี้ 6 ก.ย.)
              ...
              🔴 **และคำว่า "ทำไม่ได้" ก็ต้องผ่านเกณฑ์เดียวกัน** (แก้รอบสอง 6 ก.ย.)
                 ...
                 ข้อมูลอาจมาทาง `GetProducts?warehousecode=` หรือซ่อนใน GetProductDetail
                 ⇒ หลักฐานที่มีตอนนี้พิสูจน์ได้แค่ "ไม่มีเส้นชื่อนั้น" ⇒ เขียนได้แค่ "ยังไม่พบทาง"
          ...
          <div className="text-[12.5px] text-amber-900 bg-amber-50 border border-amber-300 rounded-md px-3.5 py-2.5 mb-3 leading-relaxed">
            ...
            แยกดูรายคลัง<b>ยังหาทางไม่เจอ</b> — กวาดชื่อเส้นแล้ว 30+ ชื่อไม่พบ
            แต่<b>ยังไม่ได้ลองระดับพารามิเตอร์</b> (เช่น ส่งรหัสคลังเข้าไปในเส้นเดิม)
            ⇒ <b>ยังไม่พบทาง ไม่ใช่ทำไม่ได้</b> ·{' '}
