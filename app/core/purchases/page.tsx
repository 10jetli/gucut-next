        ...
        actions={
          <>
            ...
            {/* 🔴 เคยชี้ไป /core/soon/buy-create ทั้งที่หน้าจริงมีตั้งแต่ 6 ก.ย. 2569 (แก้ 14 ก.ย.)
                ...
                🔴 **บรรทัดนี้เคยเขียนว่า "ปุ่มส่งจริงในหน้านั้นยังปิดอยู่โดยตั้งใจ
                   (เจ้าของร้านอนุมัติการเขียนจริงเฉพาะใบเสนอราคา)" — เป็นเท็จมา 5 วัน**
                   ท่านประธานสั่งเปิด `/core/purchases/new` ตั้งแต่ 14 ก.ย. 2569 (ใบ t_mu1bh3s7)
                   แต่ข้อความนี้ไม่ได้ผูกกับสวิตช์จริง จึงไม่มีอะไรฟ้องตอนสวิตช์เปลี่ยน
                   ⇒ ย้ายสถานะไปที่ `lib/real-send.ts` ที่เดียว (ใบ S4 · 19 ก.ย. 2569)
                   ⚠️ หน้านั้น **ส่งจริงเข้า ZORT ได้แล้ว** (เฉพาะใบปกติ · โหมด ?quick=1 ยังปิด) */}
