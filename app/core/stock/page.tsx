            ...
            <table className="w-full min-w-[920px]">
              <thead className="bg-white border-b border-gray-200">
                ...
                <tr>
                  ...
                  <th className={THR}>
                    {/* 🔴 **คำกำกับเดิมหมดอายุ — แก้ 18 ก.ย. 2569**
                        เคยเขียนว่า "ท่อของเรายังเรียงตามจำนวนพร้อมขายไม่ได้ — ขอฝั่งท่อไว้แล้ว"
                        ยิงตรวจวันนี้: ท่อเรียงได้แล้วครบ (sortApplied ตอบกลับทั้ง available และ availablelow)
                        ⚠️ แต่ **ไม่ได้เพิ่มลงตัวเลือกเรียง** เพราะวัดแล้วมันแทบไม่ต่างจาก "ของใกล้หมดก่อน":
                           กวาดทั้งคลัง 2,674 แถว พบ พร้อมขาย ต่างจาก คงเหลือ **แค่ 4 แถว**
                           ⇒ เพิ่มไปก็ได้ลำดับเกือบเหมือนเดิม = ตัวเลือกที่กดแล้วเหมือนไม่ได้กด
                        ⚠️ และ **ไม่ยืนยันว่าจอ ZORT กดเรียงช่องนี้ได้** — อ่าน DOM จริงแล้วหัวตารางไม่มีตัวสั่งเรียง
                           มีแต่ปุ่มล้างการเรียงที่จำไว้ (doconfirmremovecookiesort) ⇒ ยังไม่รู้ ห้ามเขียนว่ารู้ */}
                    <span title="ท่อเรียงตามช่องนี้ได้แล้ว แต่ในข้อมูลร้านนี้ พร้อมขาย ต่างจาก คงเหลือ เพียง 4 จาก 2,674 แถว จึงยังไม่ใส่เป็นตัวเลือกเรียง">พร้อมขาย</span>
                  </th>
