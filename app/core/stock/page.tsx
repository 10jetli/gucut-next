...
function CoreStockInner() {
  ...
  /* 🔎 **แถวที่คนดูมองไม่เห็นว่าทำไมถึงติดคำค้น** (วัดของจริง 16 ก.ย. 2569 · ใบ t_mu2u9mym)
     ...
     ⇒ ท่อค้นในช่องที่ตารางนี้ไม่ได้แสดงด้วย **ยังไม่รู้ว่าช่องไหน**
     🔬 **ตัดออกไปแล้ว 2 ข้อสันนิษฐาน (16 ก.ย. 2569) — อย่าเสียเวลาลองซ้ำ**
        ① ไม่ใช่ **ชื่อหมวดหมู่**: ทดสอบครบทั้ง 6 หมวดที่ชื่อมีคำว่า "โซ่" (รวม 32 รหัส)
           ไม่มีรหัสตัวอย่าง (`03409-3` ตะไบ · `01876` แผ่น) อยู่ในหมวดไหนเลย
        ② ไม่ใช่ช่องใน **รายละเอียดสินค้าของท่อ** (`?zortproduct=`) — ทั้ง 10 ช่องที่ท่อส่ง
           (sku · name · barcode · sellprice · purchaseprice · stock · availablestock · unittext · imagepath · id)
           ไม่มีช่องไหนมีคำว่า "โซ่" เลย
        ⇒ น่าจะเป็นคอลัมน์ในกระจกที่ท่อไม่ได้ส่งออกมา — **ถามฝั่งท่อไปแล้ว** (ขอชื่อช่องที่ `q` ครอบ)
