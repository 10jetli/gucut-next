  ...
  return (
    <div className="p-4 md:p-6 max-w-[1000px]">
      ...
      {/* 🔬 **เทียบกับจอ ZORT ตัวจริง** — ใบงานยืน t_mu2u9mym · อ่านอย่างเดียว 16 ก.ย. 2569
          ...
          🔴 **จุดที่ยังไม่รู้และห้ามเดา**: จอ ZORT มีคอลัมน์ "จำนวน" ซึ่งจอเราไม่มี
             ⇒ ยังไม่รู้ว่า ZORT เอาจำนวนไปคิดต้นทุนเฉลี่ยใหม่หรือเปล่า
             ท่อของเราเขียนค่า `purchaseprice` ตรง ๆ ⇒ **ยังยืนยันไม่ได้ว่าเป็นการกระทำเดียวกับจอ ZORT**
             (ขอให้ฝั่งท่อ/ท่านประธานยืนยันก่อนเปิดปุ่มส่งจริง — นี่คือเหตุผลเพิ่มอีกข้อที่ยังปิดปุ่มอยู่) */}
      <div className="text-[12px] text-gray-600 bg-gray-50 border border-gray-200 rounded-md px-3.5 py-2.5 mb-3 leading-relaxed">
        ...
        <ul className="list-disc ml-5 mt-1 space-y-0.5">
          ...
          <li>
            ⚠️ คอลัมน์ของ ZORT มี <b>จำนวน</b> กับ <b>ราคา/หน่วย</b> ส่วนจอเราแก้แค่ราคาซื้อ ·
            <b>ยังไม่รู้ว่า ZORT เอาจำนวนไปคิดต้นทุนเฉลี่ยใหม่ไหม</b> ⇒ ยังไม่ยืนยันว่าสองจอทำสิ่งเดียวกัน
          </li>
        </ul>
      </div>
