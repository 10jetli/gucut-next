    ...
    <div className="p-4 md:p-6">
      ...
      {/* 🔍 แผงค้นหาขั้นสูง — ใช้ตัวประกอบร่วม · มีเฉพาะตัวกรองที่ท่อกรองให้จริง
          ...
          🟢 **เคยต่างกัน 83 ราย — รู้สาเหตุแล้ว: กระจกค้าง ไม่ใช่ท่อทิ้งข้อมูล** (ฝั่งท่อพิสูจน์ 15 ก.ย. 2569)
             ...
             ⚠️ ที่ยังไม่จบ: **รายเก่าที่ถูกแก้ทีหลัง กระจกยังไม่ตาม** (ซิงก์ดูแต่ของใหม่)
             📌 รอเส้น `syncedAtUtc` จากฝั่งท่อ แล้วค่อยเอา **เวลาซิงก์ล่าสุดขึ้นจอ** — สำคัญกว่าตัวเลขตรง
                เพราะเลขบนจอที่ไม่มีเวลากำกับ คนอ่านจะเชื่อว่าเป็นของสด (กฎข้อ 4 ใน CLAUDE.md) */}
      <AdvancedSearch
        open={advOpen}
        fields={[
