  ...
  return (
    <div className="p-4 md:p-6">
      ...
      {/* 🔍 แผงค้นหาขั้นสูง — ใช้ตัวประกอบร่วม · มีเฉพาะตัวกรองที่ท่อกรองให้จริง
          ...
          🟡 **สองแหล่งไม่ตรงกัน 83 ราย — ยังไม่รู้สาเหตุ อย่าเลือกข้างใดข้างหนึ่ง**
             ท่อ (`list=contacts`) ว่า **28,250** · จอ ZORT `/Contact/list` อ่านเอง 15 ก.ย. 08:2x ว่า **28,333**
             อ่านคนละเวลาในวันเดียวกัน ⇒ อาจเป็นของใหม่ที่เข้ามาระหว่างวัน หรือท่ออาจนับไม่รวมบางชนิดผู้ติดต่อ
             ⇒ แจ้งฝั่งท่อแล้ว (ตู้ CEO 15 ก.ย.) · **ห้ามแก้เลขในคอมเมนต์นี้ให้ตรงกันเองโดยไม่รู้เหตุ**
                เพราะนั่นคือ "ทำให้ดูตรง" ไม่ใช่ "ทำให้ถูก" — กฎข้อ 4 ใน CLAUDE.md (เลขจากสองแหล่งห้ามวางคู่กันเฉย ๆ) */}
      <AdvancedSearch
        open={advOpen}
        fields={[
        ...
        <>
          ...
          {!hasType && (
            <p className="text-[12px] text-amber-800 bg-amber-50 border-x border-b border-amber-200 px-3.5 py-2 leading-relaxed">
              ...
              <b> Undefined ครบทั้ง 1,000 รายที่สุ่มตรวจ</b> (5 ช่วงคนละหน้า · ตรวจ 3 ก.ย. 2569)
              และในข้อมูลดิบ
