      ...
      {data && !data.skip && (
        <>
          ...
          {(() => {
            ...
            return (
              <p className="text-[12px] text-gray-600 bg-gray-50 border border-gray-200 rounded px-3 py-2 mt-1 leading-relaxed">
                ...
                {' '}<b>ยังแยกดูเฉพาะใบยกเลิกไม่ได้</b> เพราะท่อยังไม่รับตัวกรองสถานะ
          ...
          {/* ⚠️ **ตัวเลขบนจอนี้น้อยกว่าที่ ZORT แสดง และต้องบอกว่าทำไม**
              ...
              ⇒ 194 ใบที่หาย = ใบที่แตะคลัง **KLD/ANJ** ซึ่งผู้ใช้ API ของเราถูกกั้นสิทธิ์ (Access Denied)
                 **แก้ได้** ด้วยการเปิดสิทธิ์คลังให้ผู้ใช้ API ใน ZORT (รอท่านประธาน) — เรื่องเดียวกับสต็อกรายคลัง
          ...
          <div className="text-[12px] text-gray-600 bg-gray-50 border border-gray-200 rounded-md px-3.5 py-2.5 mt-2 leading-relaxed">
            ...
            {' '}ส่วน 194 ใบที่ขาดคือใบที่แตะคลัง <b>KLD / ANJ</b> ซึ่ง<b>ผู้ใช้ API ของเราถูกกั้นสิทธิ์</b>
            {' '}⇒ <b>ไม่ใช่ ZORT ไม่ส่ง และไม่ใช่ข้อมูลตกหล่นฝั่งเรา</b> · แก้ได้ด้วยการเปิดสิทธิ์คลังใน ZORT
            <br />
