    ...
    try {
      const res = await fetch('/api/web/core?sale=1', {
        ...
        body: JSON.stringify({
          ...
          // ✅ ท่อเก็บวิธีจ่ายแล้ว (pos.mjs ตรวจค่า + เก็บ pay_method + สรุปยอดตามวิธีจ่าย)
          //    เดิมเขียนว่า "ท่อยังไม่มีที่เก็บ (ขอไว้แล้ว)" แล้วค้างอยู่ทั้งที่จอส่วนสรุป
          //    ใช้ข้อมูลนี้จากท่อไปแล้ว — เจอตอนกวาดคลาส stale-state 11 ก.ย. 2569
          //    การส่งล่วงหน้าตอนนั้นได้ผลตามแผน: ข้อมูลครบตั้งแต่ใบแรก ไม่ต้องเติมย้อนหลัง
          payMethod,
