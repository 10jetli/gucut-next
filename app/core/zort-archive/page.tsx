                  ...
                  <td className={TD}>
                    {/* 🔴 **คำว่า "ครบ" ที่นี่ไม่ได้แปลว่าระบบนับเองแล้วครบ**
                        ...
                        ⇒ ตัวหารมาจากคนกรอก ไม่ใช่จากระบบ · ZORT ไม่เปิด API ให้นับจอพวกนี้
                           (ยิงตรวจ 3 ก.ย. 2569 · ทบทวนอีกรอบ 6 ก.ย. 2569 — ฝั่งท่อยืนยันวันที่ให้ 14 ก.ย. 2569
                            จากหัวไฟล์ netlify/functions/zort-archive.mjs)
                           จึงไม่มีทางอื่น (ท่อเขียนเหตุผลเต็มไว้ในไฟล์นั้น)
