    ...
    <div className="p-4 md:p-6">
      ...
      {order && (
        <div className="space-y-4">
          ...
          {/* 🔬 **เทียบกับ `/Sell/Details` ของ ZORT ทีละหัวข้อ 16 ก.ย. 2569** (อ่านอย่างเดียว)
              ของเขามี 13 หัวข้อ — ที่จอนี้มีครบแล้ว: สถานะ 3 ใบ · ข้อมูล · ลูกค้า ·
              ข้อมูลการจัดส่ง (ชื่อผู้รับ · เลขพัสดุ · วันส่ง) · สินค้า (คอลัมน์ตรงกันทั้ง 7 รวมส่วนลดต่อหน่วย) ·
              การชำระเงิน/สลิป
              ⇒ เหลือ 4 หัวข้อที่ยังไม่มี + ปุ่มคำสั่งของเขา ⇒ เขียนบอกตรงนี้ ไม่ปล่อยให้คนเทียบเอง */}
          <p className="text-[12px] text-amber-900 bg-amber-50 border border-amber-200 rounded px-3 py-2">
            ⚠️ <b>ที่จอ ZORT มีแต่จอนี้ยังไม่มี</b> — กล่อง <b>ค่าใช้จ่ายอื่น</b> · <b>รายได้อื่น</b> ·
            <b> ประวัติการโอนสินค้า</b> · ช่อง <b>พูดคุย</b>
            {' '}· และปุ่ม <b>พิมพ์เอกสาร</b> · <b>บริการส่งสินค้า</b> (จองขนส่งด้วยพอยท์) ·
            <b> ส่ง SMS ให้ลูกค้า</b> · <b>โอนสินค้าออกจากคลัง</b>
            <span className="block mt-0.5 text-gray-600">
              เหตุ: ค่าใช้จ่ายอื่น/รายได้อื่นยัง<b>ไม่มีช่องในคำตอบของท่อ</b> (ท่อส่งแต่ส่วนลดท้ายบิลกับค่าส่ง) ·
              ส่วนที่เหลือเป็นการ<b>เขียนกลับไปที่ ZORT</b> ซึ่งระบบเราทำไม่ได้ตามกติกา
              {' '}· พิมพ์เอกสารทำได้แล้ว <b>2 แบบ</b> จากจอรายการขาย (ใบจัดเตรียมสินค้า · ใบส่งสินค้า)
            </span>
          </p>
