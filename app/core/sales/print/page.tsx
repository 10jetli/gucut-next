 ...
 *  ⚠️ ที่เหลือ (ใบจ่าหน้ากล่อง · ฉลากจัดส่ง · ใบวางบิล · ใบแจ้งยอดชำระ)
 *     ต้องใช้ **ที่อยู่ผู้รับแบบเต็ม**
 *  🔴 **17 ก.ย. 2569 — อ่านซอร์สของท่อแล้วพบว่านี่ไม่ใช่ "ท่อยังไม่ได้ทำ" แต่เป็น "ตั้งใจไม่ส่ง"**
 *     ZORT ส่ง `shippingname` · `shippingaddress` · `shippingphone` มาจริง แต่ฝั่งท่อ
 *     **คัดออกตั้งแต่ชั้นซิงก์** หลังเคยมีเหตุข้อมูลลูกค้าหลุดออก API (4 ก.ย. 2569)
 *     ⇒ ตอนนี้ท่อใช้ "รายชื่อฟิลด์ที่อนุญาต" ตรงตัว ห้าม regex
 *     ⇒ การจะพิมพ์ฉลากจัดส่ง/ใบจ่าหน้ากล่องเองได้ **เป็นการตัดสินใจเรื่องนโยบายข้อมูลส่วนบุคคล**
 *        (ยอมให้ที่อยู่ผู้รับเดินทางมาถึงจอไหม · ใครเห็นได้ · เก็บไว้นานแค่ไหน)
 *        ไม่ใช่งานที่ฝั่งท่อ "ลืมทำ" ⇒ ต้องให้ท่านประธาน/CEO ตัดสินก่อน */
const DOCS = {
