      ...
      {!loading && !error && d && (
        <>
          ...
          <div className="text-[12.5px] text-blue-900 bg-blue-50 border border-blue-100 rounded-md px-3.5 py-2.5 mt-3 leading-relaxed">
            ...
            <b> นั่งถาม ZORT เป็นรอบ ๆ</b> (ซิงก์ออเดอร์ชั่วโมงละครั้ง · กวาดใบจ่ายเงินทุกครึ่งชั่วโมง · เช็คสถานะจัดส่ง)
            {' '}⇒ ช้าสุดราว <b>หนึ่งชั่วโมง</b>กว่าจะรู้ว่ามีอะไรเปลี่ยน · ถ้า ZORT ยิงมาบอกเอง จะรู้ในไม่กี่วินาที
