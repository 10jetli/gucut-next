...
//
// 🔴 สูตรชุดอ่านได้จาก `Bundle/GetBundleDetail?id=` แล้ว (พิสูจน์ 14 ก.ย. 2569)
//    และซิงก์เข้ากระจกทุกชั่วโมง · ห้ามเดาส่วนประกอบจากชื่อชุด เพราะเดาผิดคือตัดสต็อกผิดตัว
// ⚠️ สูตรกับตัวเลขสต็อกมีเวลาซิงก์คนละตัว หน้าแสดงอายุแยกกัน ห้ามยุบเป็นเวลาเดียว
