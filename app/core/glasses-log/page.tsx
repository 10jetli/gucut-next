...
const isPing = (e: Entry) =>
  /* ฟิลด์จริงเป็นตัวตัดสิน — ท่อยืนยันสัญญาแล้ว (3949adc: ping?: boolean · build?: string)
     ⚠️ ทางถอยจับข้อความไว้เผื่อ deploy เหลื่อม (จอใหม่ + ท่อรุ่นก่อน 3949adc ที่ยังไม่มีฟิลด์)
     ...
     🗑️ **ถอดทางถอยได้เมื่อ**: ท่อรุ่น 3949adc ขึ้น production แล้ว **และ** log เก่าที่ไม่มีฟิลด์
        หมดอายุ 7 วันไปแล้ว (store ลบเองอัตโนมัติ) ⇒ ราว 17 ก.ย. 2569 เป็นต้นไป
        วิธีตรวจว่าถอดได้จริง: เปิดจอแล้วดูว่าการ์ด ping ทุกใบมี build กำกับ (= มาจากฟิลด์จริง)
        ความเสี่ยงถ้าคงไว้: คนพูดคำว่า "สัญญาณชีพ" ใส่แว่นจริง ๆ จะถูกวาดเป็นการ์ด ping
        ผิดประเภทหนึ่งใบ — ไม่ทำให้สรุปผิดทิศ แต่เป็นเหตุผลที่ไม่ควรเก็บถาวร */
