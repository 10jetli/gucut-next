                  ...
                  {v && v !== 'busy' && (
                    v.error ? (
                      ...
                      <div className="text-[12px] mt-2 border-t border-gray-100 pt-2">
                        ...
                        {/* 🔴 **ติ๊กเขียวห้ามขึ้นตอนที่ยังไม่ได้ตรวจ** (เจอของจริง 19 ก.ย. 2569)
                            ยิง `stockpushverify` แล้วท่อตอบ `inconclusive: true` + `note`
                            ว่า **"ตรวจไม่ได้ — ห้ามอ่านว่าผ่าน"** แต่จอขึ้น `✅ ถึงหน้าร้านแล้ว 0 ตัว`
                            สีเขียว ส่วนประโยคของท่อไปอยู่ล่างสุดด้วยสีเทาจาง ๆ
                            ⇒ คนอ่านได้ความว่า "ตรวจแล้ว ไม่มีอะไรค้าง" ซึ่งตรงข้ามกับความจริง
                            🔑 **ศูนย์ที่แปลว่า "ยังไม่ได้ตรวจ" กับศูนย์ที่แปลว่า "ตรวจแล้วไม่มี" ห้ามหน้าตาเหมือนกัน** */}
                        {v.inconclusive ? (
                          <span className="block text-amber-800 font-semibold">
                            ⛔ รอบนี้ <b>ตรวจไม่ได้</b>
                            {v.note ? ` — ${v.note}` : ''}
                            <span className="block font-normal">
                              ⇒ เลขด้านล่างไม่ใช่ผลตรวจ · <b>ห้ามอ่านว่าผ่าน</b> และห้ามอ่านว่าไม่ผ่าน
                            </span>
                          </span>
                        ) : (
