...
if (hits) {
  ...
  /* 🔑 ประโยคนี้ฝั่งท่อเขียน (7 ก.ย. 2569) หลังเอาเกณฑ์เดียวกันไปกวาดฝั่งเซิร์ฟเวอร์
     แล้วเจอ catch ทำนองนี้ 119 จุด แต่แก้จริงแค่จุดเดียว — จุดที่สำคัญจริง */
  console.log('\n📌 grep เจอคือ "ที่ต้องดู" ไม่ใช่ "ที่ต้องแก้" — ไล่แก้ตามรูปแบบจะสร้างบั๊กใหม่เท่าที่แก้ได้')
