...
const ยกเว้น = {
  ...
  /* ✅ ตรวจแล้ว 18 ก.ย. 2569: ท่อส่งคีย์นี้เป็น **ภาษาไทย** `ร้านที่ยังไม่รู้ยอด`
     (gucut-web/netlify/lib/core-sync.mjs — ก้อน `ยอดรวมไม่ครบ`)
     จออ่านคีย์ไทยนั้นตรง ๆ แล้วเก็บใส่ชื่ออังกฤษของตัวเอง ⇒ ไม่ใช่ชื่อช่องที่หายไป
     ⚠️ ด่านนี้จับได้ถูกแล้ว — ถ้าวันหนึ่งท่อเปลี่ยนชื่อคีย์ไทยนั้น ด่านจะไม่ฟ้อง
        เพราะชื่ออังกฤษยังอยู่ในรายการยกเว้น ⇒ **จุดที่ต้องกวาดคือสตริงคีย์ไทยในจอ** */
  'ZortMonth.unknownStores': 'app/core/coverage: ชื่อฝั่งจอ · ค่ามาจากคีย์ไทย "ร้านที่ยังไม่รู้ยอด" ของท่อ',
}
