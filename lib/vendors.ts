...
export const BILL_VENDORS: BillVendorInfo[] = [
  ...
  { id: 'apple', portal: 'https://account.apple.com/account/manage/section/subscriptions',   name: 'Apple / iCloud',    emoji: '🍎', gridName: 'Apple / iCloud', gridOrder: 6, logo: '/logos/apple.webp', everyMonth: true, /* iCloud + LINE Premium ID — มีครบ 14/14 เดือนไม่ขาดเลย */ query: '(from:apple.com OR "ใบเสร็จรับเงินจาก Apple" OR "Your receipt from Apple") (ใบเสร็จ OR receipt OR invoice)', accountId: 'gucut@icloud.com' },
