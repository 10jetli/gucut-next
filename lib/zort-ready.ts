...
//   'replace'  = 🟢 "ความสามารถ: ใช้แทน ZORT ได้เลย" — จอดู/ตรวจ ตัวเลขพิสูจน์กับ ZORT แล้ว
//                (คำนำหน้า "ความสามารถ:" เพิ่ม 19 ก.ย. 2569 — ป้ายพูดถึงความสามารถของจอ ไม่ใช่ข้อมูลรอบนี้)
